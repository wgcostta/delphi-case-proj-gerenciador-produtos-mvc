...
begin
  ...
  if (edtMaskDataIni.EditText = '__/__/____') or
    (edtMaskDataIni.EditText = '__/__/____') then
    begin
        ShowMessage('Informe uma data válida');
        if edtMaskDataIni.CanFocus then
          edtMaskDataIni.SetFocus;
          Abort;
    end;
