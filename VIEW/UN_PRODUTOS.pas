...
begin
  ...
  try
    ...
    begin
      ShowMessage('A Descrição deve ser preechida');
      edtDescricao.SetFocus;
      Abort;
    end;
    if VarToStr(cbCategoria.KeyValue) = EmptyStr then
    begin
    ...
    begin
      ShowMessage('O Preço deve ser inserido');
      edtPreco.SetFocus;
      Abort;
    end;
    ...
    begin
      // Codigo := -1;
      Descricao := edtDescricao.Text;
      CodigoCategoria := StrToInt(VarToStr(cbCategoria.KeyValue));
      // mostrar Descricao da Categoria selecionada.
      case cbSituacao.ItemIndex of
        0:
          Situacao := 'A';
