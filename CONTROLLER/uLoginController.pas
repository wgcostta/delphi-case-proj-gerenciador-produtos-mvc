...
type
  ...
  public
    ...
    function GravarSenha(senha: String): Boolean;

  end;

implementation

function TLoginController.GravarSenha(senha: String): Boolean;
begin
  {
    Persistência com elementos do CDS
  }
  DM_USUARIO.CDS_LOGIN.Edit;
  DM_USUARIO.CDS_LOGINSENHA.AsString := senha;
  DM_USUARIO.CDS_LOGIN.Post;
  DM_USUARIO.CDS_LOGIN.ApplyUpdates(0);
end;
